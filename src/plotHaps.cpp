...
void printHelp(void){
  ...
  cerr << "INFO: plotHaps  --target 0,1,2,3,4,5,6,7 --background 11,12,13,16,17,19,22 --file my.vcf --deltaaf 0.1 --ancestral 0        " << endl;
  ...
  cerr << "INFO: required: y,type       -- genotype likelihood format: PL GL or GP                                                     " << endl;
  cerr << endl;
