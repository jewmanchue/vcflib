...
void printHelp(void){
  ...
  cerr << "INFO: required: f,file       -- a properly formatted phased VCF file                                                       " << endl;
  cerr << "INFO: required: y,type       -- type of genotype likelihood: PL, GL or GP                                                  " << endl;
  cerr << endl;
